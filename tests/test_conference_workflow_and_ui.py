...
class ConferenceWorkflowAndUiTest(unittest.TestCase):
    ...
    def test_frontend_triggers_conference_retrieval_workflow(self):
        ...
        self.assertIn("/api/local/results/", server)
        self.assertIn("delete_run_result", server)
        ...
        self.assertIn("sidebar-day-menu-item-delete", docsify)
        self.assertIn("Delete Result", docsify)
        self.assertIn("/api/local/results/", docsify)
        self.assertIn("method: 'POST'", docsify)
        self.assertIn("deleteDayResult", docsify)
        self.assertIn("runConferenceRetrieval(conf, years, {", manager)
        self.assertIn("profile_tag: profileTags.join(',')", manager)
        self.assertIn("Conference Paper Search", manager)
